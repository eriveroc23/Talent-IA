...
SISTEMA_PROMPT = SystemMessagePromptTemplate.from_template(
    """Actúa como un Auditor Senior de Licitaciones de Infraestructura con más de 20 años de experiencia 
    en la integración de propuestas técnicas para organismos internacionales (BM, BID) y dependencias 
    nacionales (SICT, ARTF, CFE). 
    Tu objetivo es realizar una validación de solvencia técnica quirúrgica de un Currículum Vitae 
    frente a los Términos de Referencia (TDR) de una licitación específica.
